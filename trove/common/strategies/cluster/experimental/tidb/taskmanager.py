...
class TiDbClusterTasks(task_models.ClusterTasks):
    ...
    def grow_cluster(self, context, cluster_id, instance_ids):
        LOG.debug("begin grow_cluster for TiDb cluster %s", cluster_id)
        ...
        LOG.debug("end grow_cluster for TiDb cluster %s", self.id)

    def shrink_cluster(self, context, cluster_id, instance_ids):
        LOG.debug("begin shrink_cluster for TiDb cluster %s", cluster_id)
        ...
        LOG.debug("end shrink_cluster for TiDb cluster %s", self.id)
